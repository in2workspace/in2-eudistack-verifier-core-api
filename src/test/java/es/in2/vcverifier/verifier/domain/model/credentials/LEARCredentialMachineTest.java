...
import es.in2.vcverifier.verifier.domain.model.credentials.lear.machine.subject.mandate.MandateV1;
...
class LEARCredentialMachineTest {
    ...
    void shouldBuildLEARCredentialMachineAndAccessFieldsCorrectly() {
        ...
        // Mandate
        MandateV1 mandate = es.in2.vcverifier.verifier.domain.model.credentials.lear.machine.subject.mandate.MandateV1.builder()
                .id("mandate-id")
                .mandatee(mandatee)
                .mandator(mandator)
                .build();
